module EnumField
  ...
  module ClassMethods
    ...
    #       enum_field :status, ['on', 'off', 'standby', 'sleep', 'out of this world'], :allow_nil => false
    # 
    ...
    def enum_field(field, possible_values, options={})
      ...
      validation_options = { :message => message, :in => possible_values }
      validation_options[:allow_nil] = true if options[:allow_nil]
